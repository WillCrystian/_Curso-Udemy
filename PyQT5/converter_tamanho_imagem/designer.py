...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 708, 330))
        ...
        self.btnEscolherImagem = QtWidgets.QPushButton(self.centralwidget)
        self.btnEscolherImagem.setObjectName("btnEscolherImagem")
        self.gridLayout.addWidget(self.btnEscolherImagem, 1, 4, 1, 1)
        self.inputNomeArquivo = QtWidgets.QLineEdit(self.centralwidget)
        self.inputNomeArquivo.setObjectName("inputNomeArquivo")
        self.gridLayout.addWidget(self.inputNomeArquivo, 1, 0, 1, 4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnEscolherImagem.setText(_translate("MainWindow", "Escolher Imagem"))
