...
class Calculadora(QMainWindow):
    def __init__(self, parent= None) -> None:
        ...
        # criando e configurando o display
        self.display = QLineEdit()
        self.grid.addWidget(self.display, 0, 0, 1, 5) # posição
        self.display.setDisabled(True) # desabilitando o input
    ...
    def add_btn(self, btn, row, col, rowspan, colspan, funcao= None, style= None):
        ...
        if not funcao:
            btn.clicked.connect(
                lambda: self.display.setText(
                    # pegar texto que está na tela e concatenar com botão 
